...
SENSORS: dict[str, tuple[TuyaSensorEntityDescription, ...]] = {
    ...
    "qt": (
        TuyaSensorEntityDescription(
            ...
            key=DPCode.TANK_TEMP,
            translation_key="tank temperature",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
        ),
        TuyaSensorEntityDescription(
            name="Outlet Temperature",
            key=DPCode.OUTLET_TEMP,
            translation_key="outlet temperature",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
        ),
        TuyaSensorEntityDescription(
            name="Inlet Temperature",
            key=DPCode.INLET_TEMP,
            translation_key="inlet temperature",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
        ),
        TuyaSensorEntityDescription(
            name="Discharge Temperature",
            key=DPCode.DISCHARGE_TEMP,
            translation_key="discharge temperature",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
        ),
        TuyaSensorEntityDescription(
            name="Ambient Temperature",
            key=DPCode.AMBIENT_TEMP,
            translation_key="ambient temperature",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
        ),
        TuyaSensorEntityDescription(
            name="Suction Temperature",
            key=DPCode.SUCTION_TEMP,
            translation_key=" temperature",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
        ),
        TuyaSensorEntityDescription(
            ...
            key=DPCode.EVAPOPRATOR_TEMP,
            translation_key="evaporator temperature",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
        ),
        TuyaSensorEntityDescription(
            name="Estimated Hot Water",
            key=DPCode.ESTIMATED_HOT_WATER,
            translation_key="estimated hot water",
            device_class=SensorDeviceClass.WATER,
            state_class=SensorStateClass.MEASUREMENT,
        ),
        TuyaSensorEntityDescription(
            name="Electricity Consumption",
            key=DPCode.ELECTRICITY_CONSUMPTION_1,
